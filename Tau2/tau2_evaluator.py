...
class Tau2Evaluator(GreenAgent):
    ...
    async def run_eval(self, req: EvalRequest, updater: TaskUpdater) -> None:
        ...
        # LiteLLM will use OPENAI_API_KEY and OPENAI_BASE_URL from .env
        # For custom OpenAI-compatible endpoints, use openai/ prefix
        user_llm = req.config.get("user_llm", "openai/togetherai/Qwen/Qwen3-235B-A22B-FP8")
